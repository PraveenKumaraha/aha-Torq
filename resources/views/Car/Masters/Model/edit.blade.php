    ...
    <div class="col-md-6">
        <div class="form-row">
            <div class="form-group col-md-10 col-sm-12">
                ...
                <input type="text" class="form-control" id="model-name" name="model_name" value="{{ $carModel->model_name }}" placeholder="" required>
        ...
        <div class="form-group col-md-4">
            ...
            <input type="radio" name="status" class="flat-green" value="1" {{ ( $carModel->status == 1 ) ? 'checked' : '' }} /> Active
            <input type="radio" name="status" class="flat-green" value="0" {{ ( $carModel->status == 0 ) ? 'checked' : '' }} /> In Active
        </div>
...
<script>
    ...
    $('.button-submit').click(function() {
        ...
        ajax_submit_update('carModels', "{{ $carModel->id }}")
    });
</script>